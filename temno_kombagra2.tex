...
Je-li $\langle a , r \rangle $ dobře uspořádaná množina, pak $\forall x \in a$ platí $\langle a , r \rangle $ není isomorfní s~$< (\leftarrow,x), r>$.
\end{theorem}
...
\item  $(\exists y \in b)\ \langle a , r \rangle  \ \cong \ < (\leftarrow , y),s >$ 
\item  $(\exists x \in a)\ < (\leftarrow , x),r > \ \cong \ \langle b , s \rangle $ 
\end{enumerate}
\end{theorem}
